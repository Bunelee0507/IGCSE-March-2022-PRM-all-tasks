...
while(choice!=-1):
    choice = int(input(
        "What do you want to see? -1 to abort the program. 1 for round average, 2 for per hole average, 3 for Hole in one score for the players (ignore certain numbers in this list if inapplicable), and 4 for the Winning score in relation to par. Press 5 to see every player's score in each hole. Press 6 in order to see all the hole in ones of the player's hole in ones."))
    if choice==1:
